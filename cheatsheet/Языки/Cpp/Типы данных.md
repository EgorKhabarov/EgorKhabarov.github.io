...
<div class="lang-line">
  ...
  <button class="copy-button"
          id="code3fe07659f1e1ba8fb5d7ac82dcd9780db"
          onclick="copyCode(code3fe07659f1e1ba8fb5d7ac82dcd9780d, code3fe07659f1e1ba8fb5d7ac82dcd9780db)">
...
<div class="code" id="code3fe07659f1e1ba8fb5d7ac82dcd9780d"><div class="highlight"><pre><span></span><span class="kt">int</span><span class="w"> </span><span class="n">a</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="mi">0</span><span class="p">;</span><span class="w"> </span><span class="c1">// Добавление значения сразу</span>
...
<div class="lang-line">
  <text>cpp</text>
  <button class="copy-button"
          id="code2808c8930592c08e2443606185183ecbb"
          onclick="copyCode(code2808c8930592c08e2443606185183ecb, code2808c8930592c08e2443606185183ecbb)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="code2808c8930592c08e2443606185183ecb"><div class="highlight"><pre><span></span><span class="n">cin</span><span class="w"> </span><span class="o">&gt;&gt;</span><span class="w"> </span><span class="n">some_value</span><span class="p">;</span>
</pre></div></div>
</div>
...
<div class="lang-line">
  <text>cpp</text>
  <button class="copy-button"
          id="codefc997477d5a692e4e92afaf8a026cb95b"
          onclick="copyCode(codefc997477d5a692e4e92afaf8a026cb95, codefc997477d5a692e4e92afaf8a026cb95b)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="codefc997477d5a692e4e92afaf8a026cb95"><div class="highlight"><pre><span></span><span class="kt">char</span><span class="w"> </span><span class="n">c</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="sc">&#39;1&#39;</span><span class="p">;</span><span class="w">    </span><span class="c1">// символ</span>
...
<div class="lang-line">
  <text>cpp</text>
  <button class="copy-button"
          id="code5998bc4937b2e189e41a930b808230f7b"
          onclick="copyCode(code5998bc4937b2e189e41a930b808230f7, code5998bc4937b2e189e41a930b808230f7b)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="lang-line">
  <text>cpp</text>
  <button class="copy-button"
          id="code181890f3f9b3282853d44f293af1a34eb"
          onclick="copyCode(code181890f3f9b3282853d44f293af1a34e, code181890f3f9b3282853d44f293af1a34eb)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="code181890f3f9b3282853d44f293af1a34e"><div class="highlight"><pre><span></span><span class="kt">int</span><span class="w"> </span><span class="nf">main</span><span class="p">()</span><span class="w"> </span><span class="p">{</span>
...
<div class="lang-line">
  <text>cpp</text>
  <button class="copy-button"
          id="codef40d2db4b7cb9a9e606a355c78a92114b"
          onclick="copyCode(codef40d2db4b7cb9a9e606a355c78a92114, codef40d2db4b7cb9a9e606a355c78a92114b)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="codef40d2db4b7cb9a9e606a355c78a92114"><div class="highlight"><pre><span></span><span class="kt">int</span><span class="w"> </span><span class="nf">main</span><span class="p">()</span><span class="w"> </span><span class="p">{</span>
...
<div class="lang-line">
  <text>cpp</text>
  <button class="copy-button"
          id="codef432d1b3f544e557b1176c4876768171b"
          onclick="copyCode(codef432d1b3f544e557b1176c4876768171, codef432d1b3f544e557b1176c4876768171b)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="codef432d1b3f544e557b1176c4876768171"><div class="highlight"><pre><span></span><span class="cp">#include</span><span class="w"> </span><span class="cpf">&lt;iostream&gt;</span>
<span class="w"> </span>
