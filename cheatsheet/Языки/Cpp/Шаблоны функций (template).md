...
<div class="lang-line">
  ...
  <button class="copy-button"
          id="code62e4fd01571d43db274183484d52c685b"
          onclick="copyCode(code62e4fd01571d43db274183484d52c685, code62e4fd01571d43db274183484d52c685b)">
...
<div class="code" id="code62e4fd01571d43db274183484d52c685"><div class="highlight"><pre><span></span><span class="k">template</span><span class="w"> </span><span class="o">&lt;</span><span class="k">typename</span><span class="w"> </span><span class="nc">Type1</span><span class="o">&gt;</span><span class="w"> </span><span class="c1">// Указываем что это шаблон функции</span>
...
<div class="lang-line">
  <text>cpp</text>
  <button class="copy-button"
          id="code29dc917792d2725f973ff5ba8ed262f9b"
          onclick="copyCode(code29dc917792d2725f973ff5ba8ed262f9, code29dc917792d2725f973ff5ba8ed262f9b)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="code29dc917792d2725f973ff5ba8ed262f9"><div class="highlight"><pre><span></span><span class="c1">// Здесь мы получаем сразу два типа данных</span>
...
<div class="lang-line">
  <text>cpp</text>
  <button class="copy-button"
          id="code11cf84349589855dcdc91c2a2078bb9ab"
          onclick="copyCode(code11cf84349589855dcdc91c2a2078bb9a, code11cf84349589855dcdc91c2a2078bb9ab)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="code11cf84349589855dcdc91c2a2078bb9a"><div class="highlight"><pre><span></span><span class="c1">// Вызов функции с одним параметром</span>
...
<div class="lang-line">
  <text>cpp</text>
  <button class="copy-button"
          id="codebe8b72027f42612d1c75753e147bb98db"
          onclick="copyCode(codebe8b72027f42612d1c75753e147bb98d, codebe8b72027f42612d1c75753e147bb98db)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="codebe8b72027f42612d1c75753e147bb98d"><div class="highlight"><pre><span></span><span class="cp">#include</span><span class="w"> </span><span class="cpf">&lt;iostream&gt;</span>
...
<div class="lang-line">
  <text>cpp</text>
  <button class="copy-button"
          id="code8de7c581d90b0a2bbb7567187966ff49b"
          onclick="copyCode(code8de7c581d90b0a2bbb7567187966ff49, code8de7c581d90b0a2bbb7567187966ff49b)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="code8de7c581d90b0a2bbb7567187966ff49"><div class="highlight"><pre><span></span><span class="k">template</span><span class="w"> </span><span class="o">&lt;</span><span class="k">typename</span><span class="w"> </span><span class="nc">T</span><span class="o">&gt;</span>
