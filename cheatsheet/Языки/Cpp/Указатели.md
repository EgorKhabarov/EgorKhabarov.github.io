...
<div class="lang-line">
  ...
  <button class="copy-button"
          id="codeaf11a8a40b922ab161a51f889755f5a1b"
          onclick="copyCode(codeaf11a8a40b922ab161a51f889755f5a1, codeaf11a8a40b922ab161a51f889755f5a1b)">
...
<div class="code" id="codeaf11a8a40b922ab161a51f889755f5a1"><div class="highlight"><pre><span></span><span class="kt">int</span><span class="w"> </span><span class="n">t</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="mi">237</span><span class="p">;</span><span class="w"> </span><span class="c1">// Простая переменная</span>
...
<div class="lang-line">
  <text>cpp</text>
  <button class="copy-button"
          id="codec120290ec5233337c85c5f5590fb12e4b"
          onclick="copyCode(codec120290ec5233337c85c5f5590fb12e4, codec120290ec5233337c85c5f5590fb12e4b)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="codec120290ec5233337c85c5f5590fb12e4"><div class="highlight"><pre><span></span><span class="kt">float</span><span class="w"> </span><span class="n">some</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="mi">391</span><span class="p">;</span><span class="w"> </span><span class="c1">// Простая переменная</span>
...
<div class="lang-line">
  <text>cpp</text>
  <button class="copy-button"
          id="code13efc941b2ffd420a0aa0448b0c03df2b"
          onclick="copyCode(code13efc941b2ffd420a0aa0448b0c03df2, code13efc941b2ffd420a0aa0448b0c03df2b)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="code13efc941b2ffd420a0aa0448b0c03df2"><div class="highlight"><pre><span></span><span class="kt">char</span><span class="w"> </span><span class="n">symbol</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="sc">&#39;A&#39;</span><span class="p">;</span><span class="w"> </span><span class="c1">// Простая переменная</span>
