...
<div class="lang-line">
  ...
  <button class="copy-button"
          id="code1e83db7fdac1138b239a10fbd3d97943b"
          onclick="copyCode(code1e83db7fdac1138b239a10fbd3d97943, code1e83db7fdac1138b239a10fbd3d97943b)">
...
<div class="code" id="code1e83db7fdac1138b239a10fbd3d97943"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">typing</span> <span class="kn">import</span> <span class="n">Any</span>  <span class="c1"># Любой тип</span>
</pre></div></div>
</div>
...
<div class="lang-line">
  <text>python</text>
  <button class="copy-button"
          id="codede0e644f138e0c2aaab50533948ef104b"
          onclick="copyCode(codede0e644f138e0c2aaab50533948ef104, codede0e644f138e0c2aaab50533948ef104b)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="codede0e644f138e0c2aaab50533948ef104"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">typing</span> <span class="kn">import</span> <span class="n">Literal</span>  <span class="c1"># Один из вариантов</span>
...
<div class="lang-line">
  <text>python</text>
  <button class="copy-button"
          id="codee5c52ac1fce36ea40afb230c8ce68072b"
          onclick="copyCode(codee5c52ac1fce36ea40afb230c8ce68072, codee5c52ac1fce36ea40afb230c8ce68072b)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="codee5c52ac1fce36ea40afb230c8ce68072"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">typing</span> <span class="kn">import</span> <span class="n">Union</span>
...
<div class="lang-line">
  <text>python</text>
  <button class="copy-button"
          id="code72c7508fcc92c69310f631593815fdd7b"
          onclick="copyCode(code72c7508fcc92c69310f631593815fdd7, code72c7508fcc92c69310f631593815fdd7b)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="code72c7508fcc92c69310f631593815fdd7"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">typing</span> <span class="kn">import</span> <span class="n">Final</span>
...
<div class="lang-line">
  <text>python</text>
  <button class="copy-button"
          id="code005e3534bfb116f4e36fb39b4af8a80ab"
          onclick="copyCode(code005e3534bfb116f4e36fb39b4af8a80a, code005e3534bfb116f4e36fb39b4af8a80ab)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="code005e3534bfb116f4e36fb39b4af8a80a"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">typing</span> <span class="kn">import</span> <span class="n">NoReturn</span>
...
<div class="lang-line">
  <text>python</text>
  <button class="copy-button"
          id="code1aaf8280187e9fe706371774fb7bc304b"
          onclick="copyCode(code1aaf8280187e9fe706371774fb7bc304, code1aaf8280187e9fe706371774fb7bc304b)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="code1aaf8280187e9fe706371774fb7bc304"><div class="highlight"><pre><span></span><span class="k">def</span> <span class="nf">generate_two</span><span class="p">()</span> <span class="o">-&gt;</span> <span class="n">Iterable</span><span class="p">[</span><span class="nb">int</span><span class="p">]:</span>
...
<div class="lang-line">
  <text>python</text>
  <button class="copy-button"
          id="code2489cfdf196d094a9152e0e94f887ac9b"
          onclick="copyCode(code2489cfdf196d094a9152e0e94f887ac9, code2489cfdf196d094a9152e0e94f887ac9b)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="code2489cfdf196d094a9152e0e94f887ac9"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">typing</span> <span class="kn">import</span> <span class="n">Optional</span>
...
<div class="lang-line">
  <text>python</text>
  <button class="copy-button"
          id="code8d51fba54c32457f5f13448c4ace150db"
          onclick="copyCode(code8d51fba54c32457f5f13448c4ace150d, code8d51fba54c32457f5f13448c4ace150db)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="code8d51fba54c32457f5f13448c4ace150d"><div class="highlight"><pre><span></span><span class="k">class</span> <span class="nc">LinkedList</span><span class="p">:</span>
...
<div class="lang-line">
  <text>python</text>
  <button class="copy-button"
          id="code16d35f82a95ad2cd92fd2ff7fc7c1b29b"
          onclick="copyCode(code16d35f82a95ad2cd92fd2ff7fc7c1b29, code16d35f82a95ad2cd92fd2ff7fc7c1b29b)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="code16d35f82a95ad2cd92fd2ff7fc7c1b29"><div class="highlight"><pre><span></span><span class="k">class</span> <span class="nc">LinkedList</span><span class="p">:</span>
    <span class="n">data</span><span class="p">:</span> <span class="n">Any</span>
...
<div class="lang-line">
  <text>python</text>
  <button class="copy-button"
          id="code526799fea6825cedfff50a4041459337b"
          onclick="copyCode(code526799fea6825cedfff50a4041459337, code526799fea6825cedfff50a4041459337b)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="code526799fea6825cedfff50a4041459337"><div class="highlight"><pre><span></span><span class="n">some_variable</span><span class="p">:</span> <span class="s1">&#39;somemodule.SomeClass&#39;</span>
</pre></div></div>
</div>
...
<div class="lang-line">
  <text>python</text>
  <button class="copy-button"
          id="code4a3d8ef42e351a2a509ac6a541387fcbb"
          onclick="copyCode(code4a3d8ef42e351a2a509ac6a541387fcb, code4a3d8ef42e351a2a509ac6a541387fcbb)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="code4a3d8ef42e351a2a509ac6a541387fcb"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">__future__</span> <span class="kn">import</span> <span class="n">annotations</span>
...
<div class="lang-line">
  <text>python</text>
  <button class="copy-button"
          id="code7c9f89d1101c12a85da7776598f0a884b"
          onclick="copyCode(code7c9f89d1101c12a85da7776598f0a884, code7c9f89d1101c12a85da7776598f0a884b)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="code7c9f89d1101c12a85da7776598f0a884"><div class="highlight"><pre><span></span><span class="n">T</span> <span class="o">=</span> <span class="n">TypeVar</span><span class="p">(</span><span class="s2">&quot;T&quot;</span><span class="p">)</span>
...
<div class="lang-line">
  <text>python</text>
  <button class="copy-button"
          id="code8af3c13bf6b3ec7d82b26ae4270bbceab"
          onclick="copyCode(code8af3c13bf6b3ec7d82b26ae4270bbcea, code8af3c13bf6b3ec7d82b26ae4270bbceab)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="code8af3c13bf6b3ec7d82b26ae4270bbcea"><div class="highlight"><pre><span></span><span class="n">T2</span> <span class="o">=</span> <span class="n">TypeVar</span><span class="p">(</span><span class="s2">&quot;T2&quot;</span><span class="p">,</span> <span class="nb">int</span><span class="p">,</span> <span class="nb">float</span><span class="p">)</span>
...
<div class="lang-line">
  <text>python</text>
  <button class="copy-button"
          id="coded7c9a060b536395fee932f01fa19d89ab"
          onclick="copyCode(coded7c9a060b536395fee932f01fa19d89a, coded7c9a060b536395fee932f01fa19d89ab)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="coded7c9a060b536395fee932f01fa19d89a"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">typing</span> <span class="kn">import</span> <span class="n">List</span><span class="p">,</span> <span class="n">cast</span>
...
<div class="lang-line">
  <text>python</text>
  <button class="copy-button"
          id="code675a5856267a0708c1b5dae211749358b"
          onclick="copyCode(code675a5856267a0708c1b5dae211749358, code675a5856267a0708c1b5dae211749358b)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="code675a5856267a0708c1b5dae211749358"><div class="highlight"><pre><span></span><span class="n">MyCallable</span> <span class="o">=</span> <span class="n">TypeVar</span><span class="p">(</span><span class="s2">&quot;MyCallable&quot;</span><span class="p">,</span> <span class="n">bound</span><span class="o">=</span><span class="n">Callable</span><span class="p">)</span>
