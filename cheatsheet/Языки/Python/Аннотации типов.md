...
<div class="code-element"><div class="lang-line"><text>python</text><button class="copy-button" id="code4fe30ea88be038a724e47a6a82e2eabdb" onclick="copyCode(code4fe30ea88be038a724e47a6a82e2eabd, code4fe30ea88be038a724e47a6a82e2eabdb)"><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"></path><rect x="8" y="2" width="8" height="4" rx="1" ry="1"></rect></svg><text>Copy code</text></button></div><div class="code" id="code4fe30ea88be038a724e47a6a82e2eabd"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">typing</span> <span class="kn">import</span> <span class="n">Final</span>

<span class="n">val</span><span class="p">:</span> <span class="n">Final</span> <span class="o">=</span> <span class="mi">2</span>
<span class="n">val</span> <span class="o">+=</span> <span class="mi">1</span> <span class="c1"># Ошибки не произойдёт, но idle подсветит как ошибку.</span>
</pre></div></div></div>
...
<p>Если это генераторная функция, то есть её тело содержит оператор yield, 
...
<p>Предварительное объявление</p>
...
<p>Такие типы как List или Callable, которые, мы видели раньше как раз используют механизм дженериков.
...
Также, при определении TypeVar вы можете ограничить допустимые типы:</p>
