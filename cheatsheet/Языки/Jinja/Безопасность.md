...
<div class="lang-line">
  ...
  <button class="copy-button"
          id="code615c9ad47392da41acf5f16b817a5ffab"
          onclick="copyCode(code615c9ad47392da41acf5f16b817a5ffa, code615c9ad47392da41acf5f16b817a5ffab)">
...
<div class="code" id="code615c9ad47392da41acf5f16b817a5ffa"><div class="highlight"><pre><span></span><span class="cp">{{</span> <span class="nv">user_input</span> <span class="cp">}}</span><span class="x">  </span><span class="c">{# автоматическое экранирование #}</span>
</pre></div></div>
</div>
<ul>
...
<div class="lang-line">
  <text>jinja</text>
  <button class="copy-button"
          id="code6546a40b6df017c7979e6abec18d6b4db"
          onclick="copyCode(code6546a40b6df017c7979e6abec18d6b4d, code6546a40b6df017c7979e6abec18d6b4db)">
    <svg stroke="currentColor"
         fill="none"
         stroke-width="2"
         viewBox="0 0 24 24"
...
<div class="code" id="code6546a40b6df017c7979e6abec18d6b4d"><div class="highlight"><pre><span></span><span class="cp">{{</span> <span class="nv">user_input</span> <span class="o">|</span> <span class="nf">safe</span> <span class="cp">}}</span>
</pre></div></div>
</div>
