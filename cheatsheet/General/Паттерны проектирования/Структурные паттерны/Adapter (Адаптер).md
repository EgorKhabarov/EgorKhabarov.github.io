<h2 id="Adapter(Адаптер)">Adapter (Адаптер)</h2>
...
<div class="code-element">
    ...
    <div class="code"><div class="highlight"><pre><span></span><span class="k">class</span> <span class="nc">Adaptee</span><span class="p">:</span>
