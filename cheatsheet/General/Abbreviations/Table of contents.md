...
| [[General/Abbreviations/Programming/ECS]]                        | `Entity-Component-System` архитектура, где сущности это ID, компоненты содержат только данные, а системы реализуют поведение, обрабатывая сущности с нужными компонентами                                                            |
