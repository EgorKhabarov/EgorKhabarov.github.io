...
<h1 id="GitCommitбезэтапа">Git Commit без этапа</h1>
<div class="code-element">
    ...
    <div class="code"><div class="highlight"><pre><span></span>git<span class="w"> </span>status<span class="w"> </span>--short<span class="w">  </span><span class="c1"># Увидеть изменения в более компактном виде</span>
...
<h1 id="НоваяветкаGit">Новая ветка Git</h1>
...
<div class="code-element">
    ...
    <div class="code"><div class="highlight"><pre><span></span>git<span class="w"> </span>branch<span class="w"> </span>name<span class="w">              </span><span class="c1"># Создаем новый ветки</span>
...
<h1 id="Аварийноеотделение">Аварийное отделение</h1>
...
<div class="code-element">
    ...
    <div class="code"><div class="highlight"><pre><span></span>git<span class="w"> </span>checkout<span class="w"> </span>-b<span class="w"> </span>emergency-fix<span class="w">  </span><span class="c1"># Создаем новую ветку для решения чрезвычайной ситуации</span>
...
<h1 id="Объединитьветки">Объединить ветки</h1>
...
<h1 id="Объединитьконфликт">Объединить конфликт</h1>
<div class="code-element">
    <div class="lang-line">
        <text>bash</text>
        <button class="copy-button"
