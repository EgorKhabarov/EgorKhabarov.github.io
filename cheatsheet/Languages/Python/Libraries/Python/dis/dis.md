...
Она используется для анализа низкоуровневого байт-кода Python и может быть полезна для отладки, оптимизации производительности и исследования внутренней работы интерпретатора
