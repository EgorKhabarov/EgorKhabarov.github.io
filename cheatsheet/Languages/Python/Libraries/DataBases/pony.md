...
**Pony ORM** объектно-реляционная модель (ORM) для Python, которая позволяет работать с базами данных, используя генераторы выражений Python вместо SQL-запросов
...
После создания структуры базы данных, можно добавлять, изменять, удалять и извлекать данные, используя методы Pony ORM и генераторы выражений
...
Это значит, что повторные запросы за одним и тем же объектом в рамках одной сессии не будут обращаться к базе данных
