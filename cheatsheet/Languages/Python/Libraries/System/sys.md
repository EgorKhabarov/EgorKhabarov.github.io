...
| `sys.set_coroutine_origin_tracking_depth`<br>`(depth)` | Устанавливает глубину отслеживания корутин                                                                                                          |
...
| `sys.dllhandle`                                        | **[только для Windows]**<br>Дескриптор DLL интерпретатора Python                                                                                    |
| `sys.last_type`                                        | Тип последнего неперехваченного исключения                                                                                                          |
| `sys.last_value`                                       | Значение последнего неперехваченного исключения                                                                                                     |
| `sys.last_traceback`                                   | Трассировка последнего неперехваченного исключения<br>Эти три доступны только в интерактивном сеансе<br>после того, как трассировка была напечатана |
