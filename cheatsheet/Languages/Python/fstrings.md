...
<h2 id="Field_name">Field_name</h2>
...
<h2 id="Format_spec">Format_spec</h2>
...
<h4 id="1.Доступныетипыпредставлениястрок:">1. Доступные типы представления строк:</h4>
<table>
<thead>
<tr>
...
<h4 id="2.Доступныетипыцелочисленногопредставления:">2. Доступные типы целочисленного представления:</h4>
<table>
<thead>
<tr>
<th style="text-align: center;">Тип</th>
...
<h4 id="3.Доступныетипыпредставлениядля&lt;code&gt;float&lt;/code&gt;и&lt;code&gt;Decimal&lt;/code&gt;значений:">3. Доступные типы представления для <code>float</code> и <code>Decimal</code> значений:</h4>
<table>
<thead>
<tr>
<th style="text-align: center;">Тип</th>
