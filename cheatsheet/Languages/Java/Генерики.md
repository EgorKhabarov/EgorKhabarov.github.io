<h3 id="Параметризованныетипы">Параметризованные типы</h3>
...
<h3 id="Ограничениягенераков">Ограничения генераков</h3>
<div class="code-element">
    <div class="lang-line">
        <text>java</text>
        <button class="copy-button"
...
<h3 id="Использованиенесколькихограничений">Использование нескольких ограничений</h3>
<div class="code-element">
    <div class="lang-line">
        <text>java</text>
        <button class="copy-button"
