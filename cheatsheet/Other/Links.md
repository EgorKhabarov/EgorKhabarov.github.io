...
| Лексический анализ<br>Документация Python | [https://digitology.tech/docs/python_3/reference/lexical_analysis.html#grammar-token-conversion](https://digitology.tech/docs/python_3/reference/lexical_analysis.html#grammar-token-conversion)                                                                                   |
...
|                                 |                                                                              |
|---------------------------------|------------------------------------------------------------------------------|
| Git и Github<br>Простые рецепты | [https://habr.com/ru/articles/273897/](https://habr.com/ru/articles/273897/) |
