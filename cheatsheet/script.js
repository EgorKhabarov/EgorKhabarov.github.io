...
function processingCheatSheet() {
    ...
    cheatsheet_field.querySelectorAll("blockquote").forEach(blockquote => {
        ...
        console.log(blockquote, blockquote.innerHTML, blockquote.textContent.length);
